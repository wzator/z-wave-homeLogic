...
while (!feof($fil)) {
    ...
    if (IsSet($components[8]))
    {
        $time[$i]= $components[2];
        $date[$i]= $components[1];
        $value1[$i]= $components[8];
        $i++;
    }    
}
fclose($fil);
