...
while (!feof($fil)) {
    ...
    if (IsSet($components[6]))
    {
        $time[$i]= $components[2];
        $date[$i]= $components[1];
        $value1[$i]= $components[3];
        $i++;
    }    
}
fclose($fil);
