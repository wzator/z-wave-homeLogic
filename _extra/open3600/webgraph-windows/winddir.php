...
while (!feof($fil)) {
    ...
    if (IsSet($components[9]))
    {
        $time[$i]= $components[2];
        $date[$i]= $components[1];
        $value1[$i]= $components[9];
        $i++;
    }    
}
fclose($fil);
