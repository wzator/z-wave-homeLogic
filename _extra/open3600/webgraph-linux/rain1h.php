...
while (!feof($fil)) {
    ...
    if (IsSet($components[12]))
    {
        $time[$i]= $components[2];
        $date[$i]= $components[1];
        $value1[$i]= $components[12];
        $i++;
    }    
}
fclose($fil);
